...
def analyse_columns(df: pd.DataFrame, category_threshold: int = 10) -> [dict, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
	"""
	...
	return filtered_columns, df[filtered_columns["numeric"]], df[filtered_columns["ordinal_categorical"]], df[filtered_columns["non_ordinal_categorical"]]