...
def clean_dataset(
        ...
        n_neighbors: int = 5,
        # random_state est conservé pour compatibilité API mais n'est pas utilisé pour l'instant
        random_state: int = 42
) -> pd.DataFrame:
    """
    ...
    Args:
        ...
        random_state: Pour la reproductibilité des résultats (non utilisé actuellement)
